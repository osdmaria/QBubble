    ...
    : QMainWindow{parent}, m_music(new Music())
{
    ...
    m_containerWidget2 = new ContainerWidget();
    setupUi();
    connectSignals();
    connect(m_canonModel, &CanonModel::shootSignal, this, &AlliesGameWindow::shootBubble);
...
void AlliesGameWindow::setupUi() {
    ...
    // Center CanonWidget2
    m_canonWidget2 = new CanonWidget(this, m_canonModel2,25, 100, 100); // Add cannon
...
void AlliesGameWindow::connectSignals() {
...
void AlliesGameWindow::paintEvent(QPaintEvent *event) {
...
void AlliesGameWindow::shootBubble(int angle) {
